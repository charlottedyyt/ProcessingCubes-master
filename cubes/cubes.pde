...
int signal7Low = '1';//the char printout to the serial if pin 7 is LOW
int signal8High = '8';//the char printout to the serial if pin 8 is HIGH
int signal8Low = '2';//the char printout to the serial if pin 8 is LOW
int signal9High = '9';//the char printout to the serial if pin 9 is HIGH
int signal9Low = '3';//the char printout to the serial if pin 9 is LOW
